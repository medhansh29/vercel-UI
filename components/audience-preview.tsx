    ...
    <div className="flex-1 bg-gray-50 flex flex-col h-screen">
      ...
      <div className="border-b border-gray-200 bg-white px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-gray-900 mb-1">Audience Preview</h1>
            <p className="text-sm text-gray-600">Review and configure your target audiences</p>
          </div>
        ...
        <div className="border-t border-gray-200 bg-white px-6 py-3">
          <div className="max-w-4xl mx-auto flex justify-end">
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm h-8"
            >
              {isFinalizing ? "Finalizing..." : `Save (${selectedAudienceIds.length})`}
            </Button>
          </div>
        </div>
      )}
